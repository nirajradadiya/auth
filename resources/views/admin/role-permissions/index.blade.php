...
$(document).ready(function(){
    var url = '<?php echo action('Admin\AdminRolePermissionsController@anyListAjax')?>';
    var columnsSort = [ { "orderable": false },{ "orderable": false },{ "orderable": false }];
    var order = [0, "desc"];
