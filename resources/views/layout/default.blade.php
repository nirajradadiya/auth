...
<link href="{{ SITE_URL }}public/css/default.css" rel="stylesheet" type="text/css" id="style_color"/> <!---light2 blue gray darkblue--->
...
<script src="{{SITE_URL}}js/datatable.js" type="text/javascript"></script>		
<script src="{{SITE_URL}}js/table-ajax.js" type="text/javascript"></script>

<script src="//maps.googleapis.com/maps/api/js?v=3.exp&sensor=true&libraries=places"></script>
<script src="{{ SITE_PLUGIN_URL }}gmaps/gmaps.min.js" type="text/javascript"></script>
<script src="{{SITE_URL}}js/jquery.gmap.min.js"></script>
<script src="{{SITE_URL}}js/maps-google.js"></script>
...
<!-- BEGIN HEADER -->
@include('partials.parent_panel.header')
<!-- END HEADER -->
<div class="clearfix">
</div>
<!-- BEGIN CONTAINER -->
<div class="page-container">
	...
	@include('partials.parent_panel.sidebar')
    <!-- END SIDEBAR -->
	<!-- BEGIN CONTENT -->
	@yield('content')
	<!-- END CONTENT -->
