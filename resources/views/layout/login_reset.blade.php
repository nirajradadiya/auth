...
<link href="{{ SITE_URL }}public/css/login3.css" rel="stylesheet" type="text/css"/>
<!-- END PAGE LEVEL SCRIPTS -->
<!-- BEGIN THEME STYLES -->
<link href="{{ SITE_URL }}public/css/components.css" rel="stylesheet" type="text/css"/>
...
<script src="{{ SITE_URL }}public/js/custom_script.js" type="text/javascript"></script>
<!-- END PAGE LEVEL SCRIPTS -->
<script>
